...
```{r quadgrams}
quadgramTable <- docs %>% unnest_tokens(quadgram, text, token = "ngrams", n = 4)  %>%
...
```{r save.data.for.app}
saveRDS(bigramTable, "bigrams.rds")
saveRDS(trigramTable, "trigrams.rds")
saveRDS(quadgramTable, "quadgrams.rds")
```
